...
public class Ppu
{
	...
	private ushort BackgroundTileMapBaseAddress => Cpu.GetBit(LcdControlRegister, 3) ? (ushort)0x9C00 : (ushort)0x9800;
	...
	private void RenderSprites()
	{
		...
		foreach (Sprite sprite in sprites)
		{
			...
			for (int spritePixelIndex = 7; spritePixelIndex >= 0; spritePixelIndex--)
			{
				...
				if (bufferXIndex is >= 160 or < 0 || bufferYIndex >= 144) continue;
